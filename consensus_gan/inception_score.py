...
# numpy array with values ranging from0 to 255.
class InceptionScore(object):
    def __init__(self, model_dir=MODEL_DIR, data_url=DATA_URL):
        self._init_inception(model_dir, data_url)

    def get_inception_score(self, sess, images, splits=10):
